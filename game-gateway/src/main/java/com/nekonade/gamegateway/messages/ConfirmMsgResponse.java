...
public class ConfirmMsgResponse extends AbstractJsonGameMessage<ConfirmMsgResponse.ResponseBody,ConfirmMesgRequest> {
	...
	@Override
	protected ConfirmMesgRequest newCouple() {
