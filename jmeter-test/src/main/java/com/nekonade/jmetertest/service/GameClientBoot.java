...
import com.nekonade.jmetertest.service.handler.DispatchGameMessageHandler;
...
import com.nekonade.jmetertest.service.handler.codec.ResponseHandler;
...
public class GameClientBoot {
    ...
    private static GameClientConfig gameClientConfig;

    private static GameMessageService gameMessageService;

    private static TestDispatchGameMessageService dispatchGameMessageService;
    ...
    public ChannelFuture launch() {
        ...
        gameMessageService = StressTesting.gameMessageService;
        dispatchGameMessageService = StressTesting.dispatchGameMessageService;
        ...
        future.addListener((ChannelFutureListener) future1 -> {
            if (future1.isSuccess()) {
                logger.info("连接{}:{}成功,channelId:{}", gameClientConfig.getDefaultGameGatewayHost(),
