package com.nekonade.network.message.handler.battle;

import com.nekonade.network.message.channel.battle.AbstractRaidBattleChannelHandlerContext;
import com.nekonade.network.message.channel.battle.RaidBattleChannelInboundHandler;
...
import com.nekonade.network.message.context.battle.RaidBattleUserEventContext;
import com.nekonade.network.message.rpc.DispatchRPCEventService;
import com.nekonade.network.message.rpc.battle.DispatchRaidBattleRPCEventService;
import com.nekonade.network.message.rpc.battle.RaidBattleRPCEventContext;
...
public abstract class AbstractRaidBattleMessageDispatchHandler<T> implements RaidBattleChannelInboundHandler {
    ...
    public void userEventTriggered(AbstractRaidBattleChannelHandlerContext ctx, Object evt, Promise<Object> promise) throws Exception {
        ...
        RaidBattleUserEventContext<T> utx = new RaidBattleUserEventContext<>(data, ctx);
    ...
    private void fixTimerFlushPlayer(AbstractRaidBattleChannelHandlerContext ctx) {
